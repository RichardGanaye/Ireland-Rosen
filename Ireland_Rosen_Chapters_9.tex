...
Then $A,B$ are of opposite parity. If we take $a =\frac{A+3B}{2}, b = 3B$, then $A = 2a -b, B = \frac{b}{3}$, and $4p = (2a-b)^2 + 3 b^2$, so $p = a^2 -ab + b^2$. If $\pi = a + b \omega$, then $N(\pi)= p$. Since $A = 2a-b \equiv 1 \ [3]$, and $b = 3B \equiv 0 \ [3]$, then $a \equiv -1 \pmod 3$, so $\pi$ is a primary prime.
