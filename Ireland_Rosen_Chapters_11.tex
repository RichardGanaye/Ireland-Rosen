...
\paragraph{Ex. 11.17}{\it Let the notation be as in Exercise 16. Use the Hasse-Davenport relation to show that $J(\chi'_1,\chi'_2,\ldots,\chi'_n) = (-1)^{(s-1)(n-1)} J(\chi_1,\chi_2,\ldots,\chi_n)^s$, where the $\chi_i$ are non trivial characters of $F$ and $\chi_1\chi_2\cdots \chi_n \ne \varepsilon$.
}
