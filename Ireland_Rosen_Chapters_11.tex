...
After these preliminaries, we can show that the family $\left(\lambda(f) t^{\deg(f)} \right)_{f \in M}$ is summable.% and similarly the family $\left(1 - \lambda(f) t^{\deg(f)}\right)_{f \in I}$ is multipliable.
