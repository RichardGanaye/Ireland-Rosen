...
\item[(i)] Si $\chi' = \rho'$, alors pour tout $\alpha \in K^*$, $\chi(\mathrm{N}_{K/F}(\alpha)) =\rho(\mathrm{N}_{K/F}(\alpha))$.

La proposition 7 du chapitre ``Traces et normes dans les corps finis'' montre que
$$\varphi
\left\{
\begin{array}{ccl}
K^* & \to & F^*\\
...
\right.
$$
est surjective. Par consŽquent, pour tout $\beta \in F^*$, $\chi(\beta) = \rho(\beta)$ (et $\chi(0) = 0 = \rho(0)$), donc $\chi = \rho$.
\item[(ii)] Si $\chi^m = \varepsilon$, alors pour tout $\alpha \in K$, 
$(\chi')^m(\alpha) = \chi^m(\mathrm{N}_{K/F}(\alpha)) = 1,$
donc $\chi'^m = \varepsilon$.
\item[(iii)] Si $a \in F$,
$$
\chi'(a) = \chi(N_{K/F}(a))= \chi(a^s)= \chi(a)^s.
$$
\item[(iv)] Pour tout $\alpha \in K$,
$$
(\chi \rho)'(\alpha) = (\chi \rho)(\mathrm{N}_{K/F}(\alpha)) = \chi(\mathrm{N}_{K/F}(\alpha)) \rho(\mathrm{N}_{K/F}(\alpha)) = \chi'(\alpha) \rho'(\alpha),
$$
donc  $(\chi \rho)' = \chi' \rho'$.
