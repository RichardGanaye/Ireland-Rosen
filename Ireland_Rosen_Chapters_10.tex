...
If $\gamma \in \ker(\varphi)$, then $\mathrm{tr}(\gamma \omega_1) = \ldots, \mathrm{tr}(\gamma \omega_n) = 0$. If $y$ is any element in $\F_q$, then $y = b_1 \omega_1+\cdots + b_n \omega_n$, where $b_1,\ldots, b_n \in \F_p$. Then  $\mathrm{tr} i(\gamma y) = b_1 \mathrm{tr}(\gamma \omega_1) + b_n \mathrm{tr}(\omega_n) = 0$, which gives
